...
class Lvl07:
    ...
    def run(self):
        ...
        while True:
            ...
            col_menu = (155, 89, 182)  # Violet
            col_niveaux = (241, 196, 15)  # Jaune
            if self.rect_menu.collidepoint(mouse_pos):
                col_menu = (187, 143, 206)
            if self.rect_niveaux.collidepoint(mouse_pos):
                col_niveaux = (247, 220, 111)
            ...
            self.afficher_text("LEVELS", self.police, (50, 50, 50), self.rect_niveaux.centerx, self.rect_niveaux.centery)
            
            # Titre
            self.afficher_text("Niveau 7 - Labyrinthe", self.police_titre, (255, 255, 255), WIDTH // 2, 40)

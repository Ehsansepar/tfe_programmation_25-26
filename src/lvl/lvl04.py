...
class Lvl04:
    def __init__(self, ecran, personnage):
        ...
        self.finished_rect = pygame.Rect(WIDTH-100, 150, 50, 100)
        
        # Zigzag
        self.plateformes = [
            pygame.Rect(100, 550, 150, 20),
    ...
    def run(self):
        ...
        while True:
            ...
            self.ecran.fill((60, 40, 80))
            
            # Hover boutons
            mouse_pos = pygame.mouse.get_pos()
            col_menu = (241, 196, 15)  # Jaune
            col_niveaux = (142, 68, 173)  # Violet foncé
            if self.rect_menu.collidepoint(mouse_pos):
                col_menu = (247, 220, 111)
            if self.rect_niveaux.collidepoint(mouse_pos):
                col_niveaux = (175, 122, 197)
            ...
            # Titre
            self.afficher_text("Niveau 4", self.police_titre, (255, 255, 255), WIDTH // 2, 40)

...
background = pygame.image.load("assets/images/Background/Blue.png").convert()
...
sol_hauteur = 50
terrain_tileset = pygame.image.load("assets/images/Terrain/Terrain (16x16).png").convert_alpha()

...
class Lvl06:
    def __init__(self, ecran, personnage):
        ...
        self.sol = Sol(size=(200, 20), coulor=(193, 120, 90), pos_x=0, pos_y=HEIGHT-100)
        self.finished_rect = pygame.Rect(WIDTH-100, 100, 50, 100)
        
        # Plateformes flottantes
        self.plateformes = [
            pygame.Rect(150, 550, 100, 20),
    ...
    def run(self):
        ...
        while True:
            ...
            # Titre
            self.afficher_text("Niveau 6", self.police_titre, (255, 255, 255), WIDTH // 2, 40)

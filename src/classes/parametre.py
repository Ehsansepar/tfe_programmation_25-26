    ...
    def run_parametre(self):
        ...
        while True:
            ...
            if self.clavier_panel_ouvert:
                if rect_haut.collidepoint(mouse_pos) or rect_bas.collidepoint(mouse_pos) or rect_droit.collidepoint(mouse_pos) or rect_gauche.collidepoint(mouse_pos) or opt_fermer_clavier.collidepoint(mouse_pos):
                    pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
                else:
                    pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_ARROW)
            else:
                if rect_retour.collidepoint(mouse_pos) or rect_clavier.collidepoint(mouse_pos) or rect_reinitialiser_niveaux.collidepoint(mouse_pos):
                    pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_HAND)
                else:
                    pygame.mouse.set_cursor(pygame.SYSTEM_CURSOR_ARROW)
